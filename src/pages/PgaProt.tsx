...
export default function PgaProt() {
  return (
    <div className="pgaprot-page">
      <Header />
      <main className="pgaprot-main">
        <div className="pgaprot-container">
          {/* Hero */}
          <div className="pgaprot-hero">
            <h1 className="pgaprot-title">
              Prot ja matkanjohtajat
            </h1>
            <p className="pgaprot-description">
              Tuttu suomalainen golfopettaja mukana jokaisella opetusmatkallamme.
              Kehitä peliäsi kaukana arjen häiriöistä – osaavien ammattilaisten opastuksella.
            </p>
          </div>

          {/* Pro Grid */}
          <div className="pgaprot-grid">
            {pros.map((pro, index) => (
              <div
                key={pro.id}
                className="pro-card"
          ...
          <div className="pgaprot-cta">
            ...
            <Button variant="hero" size="lg" asChild>
              <Link to="/teemamatkat/pro">Tutustu opetusmatkoihin</Link>
            </Button>
          </div>
        </div>
      </main>
